...
export const JULIA_FARNESE_RIDER_BOND: CraftEssenceDefinition = {
  schemaVersion: CRAFT_ESSENCE_DATA_SCHEMA_VERSION,
  dataId: "julia-farnese-rider-bond",
  name: "六輪の青百合",
  ...BOND_CRAFT_ESSENCE,
  ...
  fieldEffects: [
    {
      kind: "effect",
      stableId: "julia-farnese-rider-bond-female-quick",
      order: 1,
      ...
      action: { kind: "apply_effects", effects: [{ template: { stableId: "julia-farnese-rider-bond-female-quick-state", name: "Quickカード性能アップ", effectType: COMMON_EFFECT_TYPES.cardPerformance, category: "buff", value: 100, removalPolicy: "unremovable", flags: { cardType: "quick" } } }] },
    },
    {
      kind: "effect",
      stableId: "julia-farnese-rider-bond-female-critical",
      order: 2,
      description: "＆クリティカル威力をアップ：20%",
      target: { relation: "allies", selection: "all", includeReserve: true, requiredTraits: ["女性"] },
      action: { kind: "apply_effects", effects: [{ template: { stableId: "julia-farnese-rider-bond-female-critical-state", name: "クリティカル威力アップ", effectType: COMMON_EFFECT_TYPES.criticalDamage, category: "buff", value: 200, removalPolicy: "unremovable" } }] },
    },
  ],
  sources: [{
    url: "https://w.atwiki.jp/siroi_human/pages/31.html",
    checkedAt: "2026-08-31",
    note: "絆礼装「六輪の青百合」の名称、星4Lv80・ATK100・HP100、前衛中の味方全体〔女性〕へのQuick性能10%・クリティカル威力20%を照合。",
  }],
};
