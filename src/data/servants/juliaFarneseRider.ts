...
export const JULIA_FARNESE_RIDER: ServantDefinition = {
  ...
  noblePhantasm: {
    ...
    effects: [
      ...
      { kind: "attack", stableId: "julia-farnese-np-damage", order: 3, targetScope: "all", hitWeights: [1, 1, 1, 1, 1], damageMultiplierPermilleByLevel: [8_000, 10_000, 11_000, 11_500, 12_000], specialAttack: { stableId: "julia-farnese-np-evil-special-attack", requiredTargetTraits: ["悪"], multiplierPermille: 1_500 } },
