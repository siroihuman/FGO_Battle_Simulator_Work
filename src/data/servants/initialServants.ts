...
export const LIGHT_KOYANSKAYA: ServantDefinition = {
  ...
  activeSkills: [
    {
      ...
      cooldownAtMax: 8,
      effects: [
        { kind: "effect", stableId: "koyanskaya-light-innovator-bunny-np", order: 1, description: "味方単体のNPを増やす[Lv]", target: { relation: "allies", selection: "single" }, action: { kind: "change_np", amount: 5_000 } },
    ...
    },
    {
      ...
      effects: [
        ...
        { kind: "effect", stableId: "koyanskaya-light-buster-normal-np", order: 3, description: "＆「Buster通常攻撃時に自身のNPを増やす状態」を付与[Lv](3T)", target: { relation: "allies", selection: "single" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "koyanskaya-light-buster-normal-np-state", name: "Buster通常攻撃時NP増加", effectType: "trigger", category: "buff", remainingTurns: 3, trigger: { timing: "on_attack", condition: { attackKinds: ["normal_command"], cardTypes: ["buster"] }, actions: [{ target: { relation: "self", selection: "single" }, action: { kind: "change_np", amount: 1_000 } }] } } }] } },
        { kind: "effect", stableId: "koyanskaya-light-massacring-stars", order: 4, description: "＋スターを獲得[Lv]", target: { relation: "self", selection: "single" }, action: { kind: "gain_stars", amount: 20, destination: "command" } },
      ],
    },
    {
  ...
  noblePhantasm: {
    ...
    cardType: "buster",
    effects: [
      { kind: "effect", stableId: "koyanskaya-light-np-attack", order: 1, description: "自身の攻撃力をアップ(1T)", target: { relation: "self", selection: "single" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "koyanskaya-light-np-attack-state", name: "攻撃力アップ", effectType: COMMON_EFFECT_TYPES.attack, category: "buff", value: 200, remainingTurns: 1 } }] } },
      { kind: "attack", stableId: "koyanskaya-light-np-damage", order: 2, description: "＋敵全体に強力な攻撃[Lv]　Buster(x1.5)　", targetScope: "all", hitWeights: [1, 1, 1, 1, 1, 1, 1, 1], damageMultiplierPermilleByLevel: [3_000, 4_000, 4_500, 4_750, 5_000] },
      { kind: "effect", stableId: "koyanskaya-light-np-charge", order: 3, description: "＆チャージを減らす", target: { relation: "enemies", selection: "all" }, action: { kind: "change_enemy_charge", amount: -1 } },
      { kind: "effect", stableId: "koyanskaya-light-np-party-np", order: 4, description: "＋味方全体のNPを少し増やす<OC:効果UP>", target: { relation: "allies", selection: "all" }, action: { kind: "change_np", amount: { scaling: "overcharge", values: [1_000, 1_500, 2_000, 2_500, 3_000] } } },
    ],
  },
...
export const LUCIFERA: ServantDefinition = {
  ...
  activeSkills: [
    {
      ...
      effects: [
        { kind: "effect", stableId: "lucifera-familiar-buster", order: 1, description: "味方全体のBusterカード性能をアップ[Lv](3T)", target: { relation: "allies", selection: "all" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "lucifera-familiar-buster-state", name: "Busterカード性能アップ", effectType: COMMON_EFFECT_TYPES.cardPerformance, category: "buff", value: 300, remainingTurns: 3, flags: { cardType: "buster" } } }] } },
        { kind: "effect", stableId: "lucifera-familiar-attack", order: 2, description: "＆攻撃力をアップ[Lv](3T)", target: { relation: "allies", selection: "all" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "lucifera-familiar-attack-state", name: "攻撃力アップ", effectType: COMMON_EFFECT_TYPES.attack, category: "buff", value: 200, remainingTurns: 3 } }] } },
    ...
    },
    {
      ...
      effects: [
        { kind: "effect", stableId: "lucifera-sin-source-party-np", order: 1, description: "味方全体のNPを増やす[Lv]", target: { relation: "allies", selection: "all" }, action: { kind: "change_np", amount: 3_000 } },
        { kind: "effect", stableId: "lucifera-sin-source-target-np", order: 2, description: "＋味方単体のNPを増やす[Lv]", target: { relation: "allies", selection: "single" }, action: { kind: "change_np", amount: 2_000 } },
        { kind: "effect", stableId: "lucifera-sin-source-self-np", order: 3, description: "＋自身のNPを少し増やす", target: { relation: "self", selection: "single" }, action: { kind: "change_np", amount: 1_000 } },
      ],
    },
    {
      ...
      effects: [
        ...
        { kind: "effect", stableId: "lucifera-queen-np-double", order: 2, description: "＋味方単体のNPを倍化する[Lv]", target: { relation: "allies", selection: "single" }, action: { kind: "increase_np_by_current_rate", ratePermille: 1_000 } },
  ...
  classSkills: [
    { stableId: "lucifera-magic-resistance", name: "対魔力", rank: "B", effects: [{ kind: "effect", stableId: "lucifera-magic-resistance-debuff", order: 1, description: "自身の弱体耐性をアップ", target: { relation: "self", selection: "single" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "lucifera-magic-resistance-debuff-state", name: "弱体耐性アップ", effectType: COMMON_EFFECT_TYPES.debuffResistance, value: 175, ...PASSIVE } }] } }] },
    { stableId: "lucifera-dragon-riding", name: "竜種騎乗", rank: "A", effects: [
      { kind: "effect", stableId: "lucifera-dragon-riding-quick", order: 1, description: "自身のQuickカード性能をアップ", target: { relation: "self", selection: "single" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "lucifera-dragon-riding-quick-state", name: "Quickカード性能アップ", effectType: COMMON_EFFECT_TYPES.cardPerformance, value: 100, flags: { cardType: "quick" }, ...PASSIVE } }] } },
      { kind: "effect", stableId: "lucifera-dragon-riding-critical", order: 2, description: "自身のクリティカル威力をアップ", target: { relation: "self", selection: "single" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "lucifera-dragon-riding-critical-state", name: "クリティカル威力アップ", effectType: COMMON_EFFECT_TYPES.criticalDamage, value: 100, ...PASSIVE } }] } },
    ] },
    { stableId: "lucifera-divinity", name: "神性", rank: "B", effects: [{ kind: "effect", stableId: "lucifera-divinity-fixed-damage", order: 1, description: "自身に与ダメージアップ状態を付与", target: { relation: "self", selection: "single" }, action: { kind: "apply_effects", effects: [{ template: { stableId: "lucifera-divinity-fixed-damage-state", name: "与ダメージプラス", effectType: COMMON_EFFECT_TYPES.fixedDamage, value: 175, ...PASSIVE } }] } }] },
  ],
  noblePhantasm: {
    ...
    effects: [
      ...
      { kind: "attack", stableId: "lucifera-np-damage", order: 2, description: "＆強力な攻撃[Lv]　Buster(x1.5)　", targetScope: "all", hitWeights: [1, 1, 1, 1, 1], damageMultiplierPermilleByLevel: [3_000, 4_000, 4_500, 4_750, 5_000], specialAttack: { stableId: "lucifera-np-evil-special-attack", description: "＆〔悪〕特攻<OC:特攻威力UP>　Buster(x1.5)　", requiredTargetTraits: ["悪"], multiplierPermilleByOvercharge: [1_500, 1_625, 1_750, 1_875, 2_000] } },
