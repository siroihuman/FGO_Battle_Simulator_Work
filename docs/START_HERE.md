...
- 状態: No.105「李広」と絆礼装「桃李の下の蹊」、No.107「サルバドール・ダリ」と絆礼装「死してなお」、共有スキル・状態アイコン素材は`main`へ統合済み。No.056「アグリッパ」と絆礼装「船嘴の黄金冠」、〔対人〕特防の攻撃者特性条件を登録し、自動検査を完了した。ユーザー環境の実画面受入とPR統合を待つ。BattleSession、中断保存形式4・データ1.38.0、直接再開、固定シードリプレイ、カード再配布、6乱数列は維持している。
- 完成目標: `v1.0`
