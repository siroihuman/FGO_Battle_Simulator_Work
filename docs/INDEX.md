...
- 具体サーヴァントの確定済み実装カテゴリ: [`SERVANT_CLASSIFICATION.md`](SERVANT_CLASSIFICATION.md)
...
- No.007「本多忠勝」とOC別HP減少共通処理の受入状況: [`qa/HONDA_TADAKATSU_ACCEPTANCE_2026-08-21.md`](qa/HONDA_TADAKATSU_ACCEPTANCE_2026-08-21.md)
- No.057「阿遅鉏高日子根神」と宝具追加攻撃共通処理の受入状況: [`qa/AJISUKITAKAHIKONE_NO_KAMI_ACCEPTANCE_2026-08-21.md`](qa/AJISUKITAKAHIKONE_NO_KAMI_ACCEPTANCE_2026-08-21.md)
